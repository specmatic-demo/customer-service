`customer-service` is a consumer of the federated `notification-service` AsyncAPI contract.
...
Run the local validation flow from the `customer-service` repository root.
